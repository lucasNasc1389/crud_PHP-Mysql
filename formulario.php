		<form>
			...
			<label>
				Tarefa:*
				<input type="text" name="nome" required="" placeholder="Digite a tarefa"  value="<?php echo $tarefa['nome']; ?>" />
			</label>
			...
			<label>
				Prazo (Opcional):
			<input type="text" name="prazo" placeholder="dd/mm/aaaa" value="<?php echo traduz_data_para_exibir($tarefa['prazo']); ?>" />
			</label>
